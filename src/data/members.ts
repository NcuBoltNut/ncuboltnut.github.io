...
export const members: Member[] = [
  ...
  { id: 'liuyb', name: '劉禹邦', generation: 'gen-01', class: '機械四A', role: '副隊長', isLeader: false, roleTag: true, photo: '/photos/member-liuyb.jpg', photoStyle: 'object-position:35% 50%; transform:scale(1.15);', order: 2 },
  { id: 'huangcs', name: '黃承笙', generation: 'gen-01', class: '機械四B', role: '工程部控制組長', isLeader: false, roleTag: false, photo: '/photos/defult.jpg', order: 3 },
  { id: 'liudy', name: '劉東諺', generation: 'gen-01', class: '機械四B', role: '工程部機構組長', isLeader: false, roleTag: false, photo: '/photos/member-liudy.webp', order: 4 },
  ...
  { id: 'wuyt', name: '吳祐霆', generation: 'gen-03', class: '機械二A', role: '公關部儲備幹部', isLeader: false, roleTag: false, photo: '/photos/member-wuyt.jpg', photoStyle: 'object-position:center top;', order: 3 },
